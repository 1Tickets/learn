...
package com.jiaxi.tickets.auth.config;

import com.jiaxi.tickets.common.core.constant.SecurityConstants;
import com.jiaxi.tickets.common.security.component.TicketsWebResponseExceptionTranslator;
import com.jiaxi.tickets.common.security.grant.ResourceOwnerCustomeAppTokenGranter;
import com.jiaxi.tickets.common.security.service.TicketsClientDetailsService;
import com.jiaxi.tickets.common.security.service.TicketsCustomTokenServices;
...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) {
		clients.withClientDetails(ticketsClientDetailsService());
	}
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
		endpoints.allowedTokenEndpointRequestMethods(HttpMethod.GET, HttpMethod.POST).tokenServices(tokenServices())
				...
				.exceptionTranslator(new TicketsWebResponseExceptionTranslator());
	...
	public TokenEnhancer tokenEnhancer() {
		return (accessToken, authentication) -> {
			...
			TicketsUser ticketsUser = (TicketsUser) authentication.getUserAuthentication().getPrincipal();
			additionalInfo.put(SecurityConstants.DETAILS_USER, ticketsUser);
			((DefaultOAuth2AccessToken) accessToken).setAdditionalInformation(additionalInfo);
			return accessToken;
		};
	}
	 ...
	 */
	@Bean
	public ClientDetailsService ticketsClientDetailsService() {
		TicketsClientDetailsService clientDetailsService = new TicketsClientDetailsService(dataSource);
	 ...
	 */
	@Bean
	public TicketsCustomTokenServices tokenServices() {
		TicketsCustomTokenServices tokenServices = new TicketsCustomTokenServices();
		tokenServices.setTokenStore(redisTokenStore);
		tokenServices.setSupportRefreshToken(true);
		tokenServices.setReuseRefreshToken(false);
		tokenServices.setClientDetailsService(ticketsClientDetailsService());
