...
package com.jiaxi.tickets.codegen;

import com.jiaxi.tickets.common.datasource.annotation.EnableDynamicDataSource;
...
public class TicketsCodeGenApplication {

	public static void main(String[] args) {
		SpringApplication.run(TicketsCodeGenApplication.class, args);
	}
