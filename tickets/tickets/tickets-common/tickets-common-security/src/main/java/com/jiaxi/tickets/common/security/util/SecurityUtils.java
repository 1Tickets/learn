...
package com.jiaxi.tickets.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public TicketsUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof TicketsUser) {
			return (TicketsUser) principal;
		}
		return null;
	}
