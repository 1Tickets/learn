 ...
 */
@Slf4j
public class TicketsSecurityBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {
	...
	public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
		...
		beanDefinition.setBeanClass(TicketsResourceServerConfigurerAdapter.class);
