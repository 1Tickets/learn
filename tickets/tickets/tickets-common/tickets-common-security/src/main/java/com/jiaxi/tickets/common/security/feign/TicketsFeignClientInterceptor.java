...
package com.jiaxi.tickets.common.security.feign;
 ...
 */
@Slf4j
public class TicketsFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public TicketsFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
