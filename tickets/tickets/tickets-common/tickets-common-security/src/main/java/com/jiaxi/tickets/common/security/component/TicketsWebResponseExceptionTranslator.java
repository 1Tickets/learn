...
import com.jiaxi.tickets.common.security.exception.*;
 ...
 */
@Slf4j
public class TicketsWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new TicketsAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
