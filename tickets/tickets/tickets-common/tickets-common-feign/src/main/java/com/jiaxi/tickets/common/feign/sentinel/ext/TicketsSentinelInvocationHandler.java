 ...
 */
@Slf4j
public class TicketsSentinelInvocationHandler implements InvocationHandler {
	...
	TicketsSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			TicketsSentinelInvocationHandler other = (TicketsSentinelInvocationHandler) obj;
