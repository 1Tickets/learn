package com.jiaxi.tickets.common.job;

import com.jiaxi.tickets.common.job.properties.XxlExecutorProperties;
import com.jiaxi.tickets.common.job.properties.XxlJobProperties;
...
public class XxlJobAutoConfiguration {
	...
	public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties, Environment environment,
		...
		// 如果配置为空则获取注册中心的服务列表 "http://tickets-xxl:9080/xxl-job-admin"
